...
from PGN.PGN_layers  import Encoder, Decoder, Pointer, BahdanauAttention
...
class PGN(tf.keras.Model):
    def __init__(self, params):
        ...
        self.embedding_matrix = load_embedding_matrix(params['w2v_output'], params['vocab_path'], params['vocab_size'],
                                                      params['embed_size'])
        self.params = params
